...
vowserdb::INSERT(array("1" => "select me pls", "3" => "Heyy", "4" => "ahsdkahsdgasdagsjdgajsd", "8" => "a", "9" => "xxxx"), "testing");
echo "<br />SELECT test: ";
...
vowserdb::INSERT(array("text" => "This is a test message", "addedOn" => "Today", "user" => "vantezzen"), "table1");
vowserdb::INSERT(array("username" => "vantezzen", "password" => "1234", "mail" => "mail@example.com"), "table2");
